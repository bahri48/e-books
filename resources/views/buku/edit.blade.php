...
@section('content')
    <div class="overflow-x-auto px-10">
        ...
        <form action="/post-update-buku" method="post" enctype="multipart/form-data">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="mt-2">
                        <div
                            ...
                            <select name="id_kategori" id="nama_kategori"
                                ...
                                <option value="{{$buku->id_kategori}}">{{$buku->JoinToKategori->nama_kategori}}</option>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <div
                            class="flex items-center rounded-md bg-white pl-3 ring-1 ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                            <input type="text" name="judul" value="{{$buku->judul}}" id="judul"
                                class="block w-full py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <div
                            class="flex items-center rounded-md bg-white pl-3 ring-1 ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                            <input type="number" name="jumlah_halaman" id="jumlah_halaman"  value="{{$buku->jumlah_halaman}}"
                                class="block w-full py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <div
                            class="flex items-center rounded-md bg-white pl-3 ring-1 ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                            <input type="file" name="cover" id="cover" value="{{$buku->cover}}"
                    ...
                    <div class="mt-2">
                        <div
                            ...
                            <textarea name="abstrak" id="abstrak" rows="4"
                                class="block w-full resize-none py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm">{{$buku->abstrak}}</textarea>
                        </div>
                    </div>
                </div>
